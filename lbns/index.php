            ...
            <div class="row align-items-center" > 
                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        <img src="Images/logo.png" alt="Lola Abon's Logo" class="mobile-hero-logo mb-3">
                        <h1 class="hero-title">Taste the Legacy of Davao’s Finest Durian Delicacies</h1>
                        <p class="hero-subtitle">Since 1950</p>
                        <br>
                        <a href="shop.php" class="hero-btn">Explore Our Sweets</a>
                    </div>
                </div>
                <!-- Right Side Images -->
                <div class="col-lg-6 d-flex justify-content-center">
                    <div class="hero-images">
                        <img src="Images/hero.jpg" alt="Main Logo" class="main-logo">
                        <div class="product-images">
                            <img src="Images/hero1.jpg" alt="Durian Product 1">
                            <img src="Images/hero2.jpg" alt="Durian Product 2">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="about-text">
                    Lola Abon’s is a heritage confectionery brand specializing in handcrafted durian delicacies. 
                    Established in the 1950s, it has been delighting generations with its signature durian yema, 
                    macaroons, and tarts. Rooted in tradition and authenticity, Lola Abon’s continues to preserve its 
                    rich legacy while bringing the unique flavors of Davao to the world.
                </p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="story-title">A short story about us</h2>
                <p class="story-text">
                    From a humble home kitchen in the 1950s, <strong>Lola Abon</strong> crafted her first durian yema, blending traditional Filipino confectionery with Davao’s finest durian. 
                    What started as a small family business grew into a heritage brand, known for its signature sweets enjoyed across generations. 
                    Through dedication and innovation, Lola Abon’s remains a trusted name in durian delicacies, preserving tradition while embracing the future.
                </p>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="story-image-container">
                    <img src="Images/hero-bgg.png" alt="Lola Abon's History" class="story-image">
                </div>
            </div>
        </div>
    </div>
